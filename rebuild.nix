with import <nixpkgs> {};
  writeShellScriptBin "rebuild" ''
    ...
    sudo nvim /etc/nixos/shared_configuration.nix /etc/nixos/modules/elitebook/configuration.nix /etc/nixos/modules/desktop/configuration.nix /etc/nixos/flake.nix
